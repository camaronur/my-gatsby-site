...
import { fragmentMetaData, fragmentPhotoPost } from '../components/fragment'
...
function PhotosPage({
  ...
  const { instagram } = metaData.siteMetadata.socialLinks
  return (
    <Layout>
      ...
      <section id="section-hero">
        <div className="container">
          <Grid>
            ...
            <ColExtra>
              <ExternalList urls={[instagram]} />
            </ColExtra>
          </Grid>
        </div>
      </section>
      <PhotoSection  title='deneme' data={lastPhotoData.edges}>
        {/*<Html>*/}
        {/*<p>*/}
